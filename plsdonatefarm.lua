...
--FPS Boost (for people that dont want their fans to go high)
loadstring(game:HttpGet("https://raw.githubusercontent.com/iqwf/things/main/unifpsboost.lua",true))()
for i,v in pairs(getconnections(game:GetService("Players").LocalPlayer.Idled)) do
v:Disable()
end
wait(5)
if string.find(identifyexecutor(), "Synapse X") then
syn.queue_on_teleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/iqwf/script/main/plsdonatefarm.lua'))()")
else
...
if isfile('WebhookDonate.txt') then
getgenv().webhook = game:GetService('HttpService'):JSONDecode(readfile('WebhookDonate.txt'))
...
writefile('WebhookDonate.txt',game:GetService('HttpService'):JSONEncode(getgenv().webhook))
end)
end
...
local donation
wait(0) local A_1 = "Thank you for donating!" local A_2 = "All" local Event = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest Event:FireServer(A_1, A_2) 
